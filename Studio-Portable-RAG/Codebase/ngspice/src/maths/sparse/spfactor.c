...
diag_emit_matrix_factored(MatrixPtr Matrix)
{
    ...
    if (!isfinite(ratio))
        return;
    ngspice_diag_emit_matrix(Size, min_piv, max_piv, ratio);
}
